            ...
            <div className="flex flex-col gap-1">
              ...
              <AnimatePresence>
                {player.streak > 1 && (
                  ...
                  >
                    <div 
                      className="px-2 py-0.5 rounded italic font-black text-xs tracking-widest text-black"
                      style={{ backgroundColor: player.lastOrbColor || '#fff', boxShadow: `0 0 15px ${player.lastOrbColor || '#fff'}` }}
                    >
